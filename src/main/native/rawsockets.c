...
int receive_from(int sock, char* buffer, size_t buffer_length, struct sockaddr_in *dst, int readTimeoutMs)
{
...
Java_com_reservoircode_net_SocketTester_socketTest(
	JNIEnv *env, jobject obj, jstring srcIp, jstring dstIp, jint dstPort, jint readTimeoutMs, jint writeTimeoutMs) {
